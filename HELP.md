...
* The original package name 'com.azubike.ellipsis.spring-security-with-jwt' is invalid and this project uses 'com.azubike.ellipsis.springsecuritywithjwt' instead.
